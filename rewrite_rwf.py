...
args = {"data_folder": "D:\\abnormal_detection_dataset\\RWF_2000_Dataset\\",
        "graphs_folder": "./graph/resnet3d/RWF2000/", "epoch": 500, "batch_size": 1, "num_class": 1, "learning_rate": 3e-4,  # 원래 1e-4
        "decay_rate": 0.998, "num_workers": 4, "img_size": (640, 360), "img_depth": 3, "FPS": 150, "SEED": 41} # decay_rate 원래 0.98 "img_size": (320, 240), ubi-fight= (640, 360)

if not os.path.exists(args["graphs_folder"]) : os.mkdir(args["graphs_folder"])

model_save_folder = './trained_model/resnet3d/RWF2000/'
...
def train(model, device, args, train_loader, val_loader):
    ...
    optimizer = torch.optim.RMSprop(model.parameters(), lr=args["learning_rate"], weight_decay=0.0001) # .0004
