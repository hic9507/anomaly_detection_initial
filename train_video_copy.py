...
args = {"data_folder": "D:\\abnormal_detection_dataset\\UBI_FIGHTS\\videos\\videos\\",
        "graphs_folder": "./graph_rwf2000", "epoch": 50, "batch_size": 32, "num_class": 2, "learning_rate": 1e-4,
...
def train(args, device="cuda:0"):
    ...
    for epoch in range(args["epoch"]):
        ...
        print('curr_loss: ', curr_train_loss, '  ', 'curr_accuracy: ', curr_train_accuracy, )
        ...
        print('=' * 100)
        print(f"Validation Loss : {curr_test_loss}, Validation accuracy : {batch_accuracy_ / total}")
        print('=' * 100)
        # print(f"Validation Loss : {curr_test_loss}, Validation accuracy : {val_acc:.5f}")
        print('curr_loss: ', curr_test_loss, '  ', 'curr_accuracy: ', curr_test_accuracy, )
        # print('curr_loss: ', curr_test_loss, '  ', 'batch_accuracy_: ', batch_accuracy_, )
        ...
        if best_accuracy < curr_test_accuracy:
            torch.save(model.state_dict(), f"{model_save_folder}/0425rwf2000_model.pth")
    ...
    plt.savefig(args["graphs_folder"]+f"/rwf2000_acc_graph.png")
    plt.show()
    ...
    plt.xlim([1, args["epoch"]])
    plt.legend(['train', 'valid'], loc='upper left')
    plt.savefig(args["graphs_folder"]+f"/rwf2000_loss_graph.png")
    plt.show()
